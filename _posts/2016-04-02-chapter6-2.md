...
var mySong = factoryOfSong('Sing', 'Ed Sheeran', '2014');
var yourSong = factoryOfSong('Twenty-Something', 'Pet Shop Boys', '2016');

console.log(mySong.getDescription()); // 'Sing released in 2014'
console.log(yourSong.getDescription()); // 'Twenty-Something released in 2016'
```
...
var mySong = new Song('Sing', 'Ed Sheeran', '2014');
var yourSong = new Song('Twenty-Something', 'Pet Shop Boys', '2016');
...
developer.printInfo(); // 'codepink, 31'

Person('codeblue', 30); // 일반 함수로 호출

window.printInfo(); // 'codeblue, 30'
```
...
var mySong = new Song();
var yourSong = new Song();

console.log(mySong.getDescription(2014)); // 'Sing released in 2014'
console.log(yourSong.getDescription(2015)); // 'Sing released in 2015'

console.log(mySong.getDescription === yourSong.getDescription); // true
...
var mySong = Song('Sing', 'Ad Sheeran'); // new 없이 함수로 호출
